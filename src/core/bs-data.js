// BS calendar reference data.
// Each row: [bsYear, daysInMonth1 ... daysInMonth12]
// Index in the array corresponds to (bsYear - 2000).
...
export const WEEKDAYS_SHORT_NE = ['आ', 'सो', 'मं', 'बु', 'बि', 'शु', 'श'];
